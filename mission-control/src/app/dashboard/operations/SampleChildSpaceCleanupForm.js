...
export default function SampleChildSpaceCleanupForm({ status, operation }) {
  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <p className="text-sm leading-6 text-white/70">Removes only empty child rows and fixed placeholder-name patterns from the seven allowlisted sample properties. Authored spaces are retained.</p>
