    ...
    <div className="space-y-6">
      ...
      {activeTab === "raw_sources" && (
        <div className="space-y-4">
          ...
          {loading ? (
            <div className="p-12 text-center text-white/40 font-mono text-sm border border-white/5 rounded-2xl bg-[#121212]">
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div className="space-y-1 flex-1">
                        <div className="flex items-center gap-2">
                          <span className="px-2 py-0.5 rounded bg-white/5 border border-white/10 text-[10px] font-mono text-[#E8AE3C] uppercase">
                            {src.source_name}
                          </span>
              ...
              {briefings.map((b) => (
                <div key={b.id} className="p-5 rounded-2xl bg-[#121212] border border-white/10 space-y-3">
                  ...
                  <div className="p-3 rounded-xl bg-black/40 border border-white/5 text-xs text-[#F7C64E]/90 font-mono space-y-1">
                    <div className="text-[10px] text-white/40 uppercase">ScoutIt &quot;Our Take&quot;</div>
        ...
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
          <div className="w-full max-w-xl bg-[#121212] border border-white/15 rounded-3xl p-6 space-y-5 shadow-2xl">
            <div className="flex items-center justify-between border-b border-white/10 pb-4">
              ...
              <button onClick={() => setShowQuickInputModal(false)} className="text-white/40 hover:text-white">
                ✕
              </button>
            </div>
        ...
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
          <div className="w-full max-w-2xl bg-[#121212] border border-white/15 rounded-3xl p-6 space-y-5 shadow-2xl">
            <div className="flex items-center justify-between border-b border-white/10 pb-4">
              ...
              <button onClick={() => setShowPromptModal(false)} className="text-white/40 hover:text-white">
                ✕
              </button>
            </div>
            ...
            <div className="pt-2 flex justify-between items-center text-xs">
              <span className="text-white/40 font-mono">Next: Paste result into &quot;Paste &amp; Publish AI JSON&quot; button</span>
              <button
                onClick={() => {
          ...
          <div className="w-full max-w-2xl bg-[#121212] border border-white/15 rounded-3xl p-6 space-y-5 shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            {parsedPreview && (
              <div className="p-4 rounded-2xl bg-black/50 border border-[#F7C64E]/30 space-y-3">
                <div className="flex items-center justify-between text-[11px] font-mono text-[#F7C64E]">
                ...
                <div className="p-3 rounded-xl bg-[#E8AE3C]/10 border border-[#E8AE3C]/20 text-xs text-[#F7C64E]">
                  <span className="font-mono text-[10px] text-white/50 block mb-1">SCOUTIT &quot;OUR TAKE&quot;</span>
