# ScoutIt Scrollytelling — Mission Text (locked)

The six teaching messages that appear at each node along the molten-gold crack.
Author: ScoutIt (user-supplied 2026-06-12). Do not invent or reword without approval.

Centerpiece asset: `reference/golden liquid.jpeg` (user's AI-generated molten-gold
ribbon on black). This is THE crack visual — code reveals/animates it, never
replaces it.
...
- After this beat, the sequence transitions to `/about`.
