...
status: active
tags: [implementation-record, spatial-osint, intel, architecture]
updated: 2026-08-02
related: ["[[15_IMPLEMENTATION_RECORDS/README|Implementation Records]]", "[[OSINT_INTEL_ARCHITECTURE]]", "[[HANDOFF_PROMPT_SPATIAL_OSINT_AND_ARTICLES]]"]
---

# ScoutIt OSINT Intel & 3D Spatial Radar Master Architecture Blueprint

> **CRITICAL ARCHITECTURE REFERENCE:**
> This execution blueprint is mirrored from the canonical [[OSINT_INTEL_ARCHITECTURE]].
...
- **Master SQL Schema Script:** `supabase/operations/features/supabase_osint_intel_schema.sql`
- **Mission Control Admin API:** `src/app/api/admin/osint/route.js`
- **Live OSINT Flash Ticker:** `src/components/intel/OSINTFlashTicker.js`
- **Intel Hub Main Page:** `src/app/intel/page.js`
