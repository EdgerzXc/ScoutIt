...
status: stale
tags: [implementation-record, historical, coordination, handoff]
updated: 2026-08-02
related: ["[[15_IMPLEMENTATION_RECORDS/README|Implementation Records]]", "[[00_MASTER_SYNC]]", "[[WORK_SPLIT_AND_CLAUDE_CODE_QUEUE]]"]
---

# ScoutIt — Master Brief for Claude Code (everything)

**Historical note:** this was the single source of truth for Claude Code on 2026-07-24. It
superseded [[MMC_CLAUDE_CODE_BRIEF]] and the older `HANDOFF_PROMPT_*.md` chain. Full detail for
the dated items lives in [[MMC_GAP_ANALYSIS]] and [[PRODUCTION_SECURITY_AUDIT]]. Current work must
start from [[00_MASTER_SYNC]] and runtime code. The tasks below are preserved as evidence and are
...
> answers. Do NOT commit/push without founder go. Detail: [[PRODUCTION_READINESS]] (2026-07-24).
...
approved. Completes Concierge Ingest end-to-end. Detail: [[MMC_GAP_ANALYSIS]] #1.
...
Full detail + rationale: [[PRODUCTION_SECURITY_AUDIT]].
