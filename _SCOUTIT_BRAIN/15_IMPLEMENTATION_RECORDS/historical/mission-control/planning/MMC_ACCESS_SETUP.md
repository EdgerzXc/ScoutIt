...
status: stale
tags: [implementation-record, historical, mission-control, authentication, access]
updated: 2026-08-02
related: ["[[15_IMPLEMENTATION_RECORDS/README|Implementation Records]]", "[[MISSION_CONTROL_REAL_BUILD_STATUS]]", "[[HANDOFF_PROMPT_MMC_PASSWORD_LOGIN]]"]
---

# Master Mission Control — Access Setup (Vercel gate + magic-link + Google)

> **Historical access plan.** Confirm the deployed provider settings and current auth code before
> applying any step.
...
This supersedes the earlier email+password plan ([[HANDOFF_PROMPT_MMC_PASSWORD_LOGIN]]) — don't run
that one.
