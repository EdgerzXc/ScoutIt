...
status: stale
tags: [implementation-record, historical, mission-control, design, handoff]
updated: 2026-08-02
related: ["[[15_IMPLEMENTATION_RECORDS/README|Implementation Records]]", "[[MISSION_CONTROL_REAL_BUILD_STATUS]]", "[[SCOUTIT_DESIGN_BRIEF]]"]
---

# Handoff Prompt for Claude Code — Master Mission Control Visual Redesign + Instant Navigation

> **Historical handoff.** The redesign has since progressed; verify the current application
> before reusing any instruction below.
