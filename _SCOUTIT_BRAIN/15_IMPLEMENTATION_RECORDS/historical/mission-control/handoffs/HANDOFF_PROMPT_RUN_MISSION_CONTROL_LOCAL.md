...
status: stale
tags: [implementation-record, historical, mission-control, local-development, handoff]
updated: 2026-08-02
related: ["[[15_IMPLEMENTATION_RECORDS/README|Implementation Records]]", "[[MISSION_CONTROL_REAL_BUILD_STATUS]]", "[[MMC_CLAUDE_CODE_BRIEF]]"]
---

# Handoff Prompt for Claude Code — Run Master Mission Control Locally (live dev)

> **Historical handoff.** Use `mission-control/README.md` for current local-run instructions.
