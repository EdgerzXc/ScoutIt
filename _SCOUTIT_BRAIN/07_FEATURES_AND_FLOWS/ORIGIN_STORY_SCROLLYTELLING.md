...
- `src/components/cinematic/CinematicJourney.js` — current homepage golden-light journey (the mechanic to evolve).
...
- The homepage mounts `CinematicJourney`; the UFO's `fireBeam` interaction and the hidden five-tap simulator gesture also live in `src/app/page.js`.
...
## 11. Flex Layer & Founding Team Scrollytelling Integration

> **Added 2026-08-12**: Incorporates the flex layer format and team showcase directly into the manifesto scrollytelling track.

- **The Flex Layer / Section**: Serves as the ultimate interactive showcase ("flex section") where ScoutIt presents its manifesto in a full scrollytelling format with rich micro-animations, deep space physics, detailed system disclosures, and continuous camera transitions.
- **Founding Team & Contributors Showcase**:
  - Inserted as a dedicated way-point near the end of Act 4 (between Crust / People You Trust and Core Ignition).
  - Displays the founding builders, spatial engineers, data architects, and legal/regulatory advisors who built the platform.
  - Rendered with gold-accented avatar cards, interactive bio overlays, and role declarations.
