  ...
  return (
    <div className="directory-layout">
      ...
      <main className="brokers-main">
        ...
        <div className="directory-container">
          ...
          <section style={{ display: "flex", flexDirection: "column", flexGrow: 1 }}>
            ...
            {researchers !== null && filtered.length === 0 && researchers.length === 0 && (
              <div className="directory-empty">
                <h3>The Founding Researcher cohort is being assembled</h3>
                <p>ScoutIt is verifying its first roster of site researchers. Join as a Founding Researcher and your practice will be here when the first due-diligence briefs are commissioned.</p>
                <Link href="/onboarding" className="founding-cta">
                  Claim Founding Researcher &rarr;
                </Link>
              </div>
            )}
            {researchers !== null && filtered.length === 0 && researchers.length > 0 && (
              <div className="roster-state">
                <span className="roster-state-label">No researchers match these filters</span>
      ...
      <style jsx global>{`
        ...
        .coming-soon-badge { background: var(--accent); color: var(--bg, #0e0e0e); font-size: 12px; font-weight: 700; letter-spacing: .12em; padding: 4px 10px; border-radius: 3px; white-space: nowrap; flex-shrink: 0; margin-top: 2px; }
        .coming-soon-text { font-size: 13px; color: var(--text-secondary); line-height: 1.6; }
        .coming-soon-card-overlay { position: absolute; top: 12px; left: 12px; font-size: 12px; font-weight: 700; letter-spacing: .1em; color: var(--text-muted); background: var(--surface); border: .5px solid var(--border-mid); padding: 3px 8px; border-radius: 2px; z-index: 10; font-family: var(--font-mono),monospace; }
        ...
        .broker-card { background: var(--surface2); border: 1px solid var(--border); border-radius: var(--radius-md); overflow: hidden; display: flex; flex-direction: column; transition: transform var(--transition), box-shadow var(--transition), border-color var(--transition); position: relative; }
        .broker-card:hover { border-color: var(--accent-border); box-shadow: var(--shadow-md), var(--shadow-glow-soft); transform: translateY(-4px); }
        ...
        .broker-location { font-family: var(--font-mono); font-size: 12px; color: var(--accent); text-transform: uppercase; letter-spacing: .1em; margin-bottom: 8px; }
        ...
        .btn-contact { background: transparent; border: 1px solid var(--accent); padding: 8px 16px; border-radius: 4px; color: var(--accent); font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: .1em; cursor: pointer; transition: all .2s; }
        .btn-contact:hover { background: var(--accent); color: var(--bg, #000); }
        .general-tier-badge-label { position: absolute; top: 12px; right: 12px; font-size: 12px; font-weight: 700; letter-spacing: 1px; padding: 3px 8px; border-radius: 2px; font-family: var(--font-mono),monospace; z-index: 10; }
