...
describe('spendConnects edge cases', () => {
  ...
  it('successfully spends from granted first, then purchased, then earned', () => {
  ...
  it('fails to spend if amount is greater than total balance', () => {
    // default seeker gets 1 granted (starry)
  ...
  it('spends exactly the amount if it equals total balance', () => {
    addPurchasedConnects('seeker', 'starry', 2);
  ...
  it('does not modify wallet if spend fails', () => {
  ...
  it('spends only from purchased when granted is zero', () => {
  ...
  it('spends exactly 0 connects successfully', () => {
    const beforeWallet = getWallet('seeker', 'starry');
  ...
  it('handles default amount of 1', () => {
  ...
  it('handles earned spending when purchased is zero', () => {
  ...
  it('does not throw when amount is negative (returns success without deduction)', () => {
    const beforeWallet = getWallet('seeker', 'starry');
  ...
  it('returns remaining accurately on successful spend', () => {
