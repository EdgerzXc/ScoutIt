export default function ProfileProvenanceBadge({ isPilotParticipant = false }) {
  ...
  return (
    <span
      ...
      className="inline-flex items-center rounded-full border border-gold-accent/35 bg-gold-accent/10 px-3 py-1 font-mono text-[12px] uppercase leading-none tracking-[0.12em] text-gold-accent"
    >
