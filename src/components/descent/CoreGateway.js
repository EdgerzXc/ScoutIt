...
export default function CoreGateway() {
  ...
  return (
    <main className="core-gateway">
      ...
      <style jsx global>{`
        .core-gateway{min-height:100vh;padding-top:52px;background:radial-gradient(circle at 50% 20%,rgba(var(--accent-rgb),.08),transparent 34%),var(--bg);color:var(--text-primary);overflow-x:hidden;position:relative}.core-gateway-bg{position:fixed;inset:0;z-index:0;pointer-events:none;opacity:.42}.core-gateway-pane{position:relative;z-index:1}.core-threshold{max-width:1180px;margin:0 auto;padding:clamp(80px,10vw,150px) clamp(20px,5vw,68px)}.core-kicker{font-family:var(--font-mono);font-size:9px;letter-spacing:.18em;text-transform:uppercase;color:var(--accent)}.threshold-heading{display:grid;grid-template-columns:1.2fr .8fr;gap:clamp(34px,8vw,110px);align-items:end;margin-bottom:60px}.threshold-heading h2{font-family:var(--font-display);font-size:clamp(2.8rem,6vw,5.8rem);line-height:.98;letter-spacing:-.045em;margin:20px 0 0}.threshold-heading p{color:var(--text-secondary);font-size:15px;line-height:1.7;max-width:50ch}.core-role-shell{display:grid;grid-template-columns:minmax(240px,.48fr) minmax(0,1.52fr);border:1px solid var(--border-solid);border-radius:22px;overflow:hidden;background:rgba(var(--bg-rgb),.84);backdrop-filter:blur(22px);box-shadow:var(--shadow-lg)}.core-role-index{background:rgba(var(--surface-rgb),.74);border-right:1px solid var(--border-solid)}.core-role-index button{width:100%;min-height:86px;padding:14px 18px;border:0;border-bottom:1px solid var(--border-solid);background:transparent;color:var(--text-primary);display:grid;grid-template-columns:34px 1fr;gap:4px 10px;text-align:left;cursor:pointer}.core-role-index button:last-child{border-bottom:0}.core-role-index span{grid-row:1/3;font-family:var(--font-mono);font-size:8px;color:var(--text-muted);padding-top:4px}.core-role-index strong{font-family:var(--font-display);font-size:1.1rem}.core-role-index small{font-family:var(--font-mono);font-size:8px;letter-spacing:.1em;text-transform:uppercase;color:var(--text-muted)}.core-role-index button.is-active{background:rgba(var(--accent-rgb),.09);box-shadow:inset 2px 0 0 var(--accent)}.core-role-index button.is-active span,.core-role-index button.is-active small{color:var(--accent)}.core-role-preview{min-height:430px;padding:clamp(36px,6vw,76px);background:radial-gradient(circle at 88% 12%,rgba(var(--accent-rgb),.09),transparent 40%),var(--surface2);display:flex;flex-direction:column;justify-content:center}.core-role-preview h3{font-family:var(--font-display);font-size:clamp(2.5rem,5vw,4.8rem);line-height:1;letter-spacing:-.045em;margin:18px 0 22px;max-width:14ch}.core-role-preview>p{color:var(--text-secondary);font-size:15px;line-height:1.72;max-width:62ch}.core-orbit-line{display:grid;grid-template-columns:repeat(5,1fr);margin-top:34px;border:1px solid var(--border-solid);border-radius:14px;overflow:hidden}.core-orbit-line span{min-height:66px;padding:12px;border-right:1px solid var(--border-solid);display:flex;flex-direction:column;justify-content:space-between;font-family:var(--font-mono);font-size:8px;letter-spacing:.09em;text-transform:uppercase;color:var(--text-secondary)}.core-orbit-line span:last-child{border-right:0}.core-orbit-line i{font-style:normal;color:var(--accent);font-size:8px}.core-continue,.core-account>a,.core-final-transition>a{align-self:flex-start;margin-top:28px;min-height:42px;padding:0 16px;border:1px solid var(--accent-muted);border-radius:12px;display:inline-flex;align-items:center;color:var(--text-primary);font-family:var(--font-mono);font-size:8px;letter-spacing:.12em;text-transform:uppercase}.core-continue span,.core-account>a span,.core-final-transition>a span{color:var(--accent);margin-left:8px}.core-account{margin-top:18px;padding:24px clamp(20px,4vw,38px);border:1px solid var(--border-solid);border-radius:18px;background:rgba(var(--surface-rgb),.7);display:grid;grid-template-columns:.75fr 1.25fr auto;gap:32px;align-items:center;backdrop-filter:blur(18px)}.account-state{display:flex;gap:14px;align-items:center}.account-state>div{display:flex;flex-direction:column;gap:7px}.account-state strong{font-family:var(--display);font-size:1rem}.account-dot{width:9px;height:9px;border-radius:50%;background:var(--text-muted)}.account-dot.signed-in{background:var(--accent-bright);box-shadow:0 0 16px rgba(var(--accent-bright-rgb),.65)}.core-account p{color:var(--text-secondary);font-size:12px;line-height:1.65;margin:0}.core-account>a{margin:0;white-space:nowrap}.core-final-transition{max-width:1180px;margin:0 auto;padding:clamp(90px,13vw,180px) clamp(20px,5vw,68px)}.core-final-transition h2{font-family:var(--font-display);font-size:clamp(2.8rem,6vw,6rem);line-height:.98;letter-spacing:-.05em;margin:22px 0 0}.core-final-transition h2 em{color:var(--accent);font-weight:inherit}.core-final-transition>a{margin-top:38px}
