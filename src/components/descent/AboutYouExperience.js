...
export default function AboutYouExperience() {
  ...
  return (
    <main className="about-core-page">
      ...
      <style jsx global>{`
        .about-core-page{min-height:100vh;padding-top:52px;background:var(--bg);color:var(--text-primary);overflow-x:hidden;position:relative}.about-core-bg{position:fixed;inset:0;z-index:0;pointer-events:none;opacity:.32}.about-core-scrim{position:fixed;inset:0;z-index:1;pointer-events:none;background:radial-gradient(circle at 50% 30%,rgba(var(--bg-rgb),.55),var(--bg) 78%)}.about-core-content{position:relative;z-index:2;max-width:1180px;margin:0 auto;padding:0 clamp(20px,5vw,68px)}.about-core-kicker{font-family:var(--font-mono);font-size:12px;letter-spacing:0.12em;text-transform:uppercase;color:var(--accent)}.about-core-hero{min-height:min(780px,calc(100vh - 52px));display:flex;flex-direction:column;align-items:flex-start;justify-content:center;max-width:980px;padding:80px 0}.about-core-hero h1,.about-core-close h2{font-family:var(--font-display);font-size:clamp(3.2rem,7.8vw,7.3rem);line-height:.94;letter-spacing:-.055em;margin:22px 0 30px}.about-core-hero h1 em,.about-core-close h2 em{color:var(--accent);font-weight:inherit}.about-core-hero p{max-width:64ch;color:var(--text-secondary);font-size:clamp(1rem,1.4vw,1.18rem);line-height:1.72}.about-core-primary,.about-core-secondary{min-height:44px;padding:0 18px;border-radius:13px;display:inline-flex;align-items:center;justify-content:center;font-family:var(--font-mono);font-size:12px;font-weight:700;letter-spacing:.13em;text-transform:uppercase}.about-core-primary{margin-top:28px;background:var(--accent-bright);border:1px solid var(--accent-bright);color:var(--bg)}.about-core-secondary{margin-top:28px;border:1px solid var(--border-solid);color:var(--text-primary);background:rgba(var(--surface-rgb),.55)}.about-core-section{scroll-margin-top:70px;padding:clamp(90px,12vw,170px) 0;border-top:1px solid var(--border-solid)}.about-core-heading{display:grid;grid-template-columns:1.2fr .8fr;gap:clamp(34px,8vw,110px);align-items:end;margin-bottom:56px}.about-core-heading h2{font-family:var(--font-display);font-size:clamp(2.7rem,5.8vw,5.4rem);line-height:.98;letter-spacing:-.045em;margin:20px 0 0}.about-core-heading>p{color:var(--text-secondary);font-size:16px;line-height:1.7;max-width:50ch}.about-role-tabs{display:grid;grid-template-columns:repeat(4,1fr);border:1px solid var(--border-solid);border-radius:16px;overflow:hidden}.about-role-tabs button{min-height:74px;padding:12px;border:0;border-right:1px solid var(--border-solid);background:rgba(var(--surface-rgb),.64);color:var(--text-primary);display:grid;grid-template-columns:24px 1fr;gap:3px 8px;text-align:left;cursor:pointer}.about-role-tabs button:last-child{border-right:0}.about-role-tabs span{grid-row:1/3;font-family:var(--font-mono);font-size:12px;color:var(--text-muted)}.about-role-tabs strong{font-family:var(--font-display);font-size:1rem}.about-role-tabs small{font-family:var(--font-mono);font-size:12px;letter-spacing:.09em;text-transform:uppercase;color:var(--text-muted)}.about-role-tabs button.is-active{background:rgba(var(--accent-rgb),.1);box-shadow:inset 0 -2px 0 var(--accent)}.about-role-tabs button.is-active span,.about-role-tabs button.is-active small{color:var(--accent)}.about-role-tabs button:disabled{cursor:wait}.about-role-intro{max-width:800px;margin:clamp(52px,8vw,90px) auto 30px;text-align:center}.about-role-intro h3{font-family:var(--font-display);font-size:clamp(2.5rem,5vw,4.8rem);line-height:1;letter-spacing:-.045em;margin:18px 0}.about-role-intro p{color:var(--text-secondary);font-size:16px;line-height:1.7}.core-schematic{width:min(780px,100%);aspect-ratio:1.65;margin:0 auto;position:relative}.schematic-ring{position:absolute;inset:15%;border:1px solid rgba(var(--accent-rgb),.22);border-radius:50%;box-shadow:inset 0 0 50px rgba(var(--accent-rgb),.03)}.schematic-center{position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);width:150px;height:150px;border-radius:50%;display:flex;flex-direction:column;align-items:center;justify-content:center;background:radial-gradient(circle,rgba(var(--accent-rgb),.2),var(--surface) 68%);border:1px solid var(--accent-muted);box-shadow:0 0 48px rgba(var(--accent-rgb),.12);z-index:2}.schematic-center span,.schematic-center small{font-family:var(--font-mono);font-size:12px;letter-spacing:.12em;text-transform:uppercase;color:var(--accent)}.schematic-center strong{font-family:var(--font-display);font-size:1.45rem;margin:5px 0}.schematic-node{position:absolute;width:150px;min-height:64px;padding:10px 14px;border:1px solid var(--border-solid);border-radius:13px;background:var(--surface);color:var(--text-primary);display:flex;align-items:center;gap:12px;text-align:left;cursor:pointer;z-index:3}.schematic-node span{font-family:var(--font-mono);font-size:12px;color:var(--text-muted)}.schematic-node strong{font-family:var(--font-mono);font-size:12px;letter-spacing:.1em;text-transform:uppercase}.schematic-node.is-active{border-color:var(--accent);background:rgba(var(--accent-rgb),.1);box-shadow:0 0 24px rgba(var(--accent-rgb),.1)}.schematic-node.is-active span{color:var(--accent)}.schematic-node.node-1{left:6%;top:9%}.schematic-node.node-2{right:6%;top:9%}.schematic-node.node-3{right:6%;bottom:9%}.schematic-node.node-4{left:6%;bottom:9%}.step-detail{display:grid;grid-template-columns:1fr auto;gap:40px;align-items:end;padding:clamp(28px,5vw,54px);border:1px solid var(--border-solid);border-radius:18px;background:rgba(var(--surface-rgb),.76);backdrop-filter:blur(18px)}.step-copy h3{font-family:var(--font-display);font-size:clamp(2rem,4vw,3.5rem);margin:14px 0;outline:none}.step-copy p{color:var(--text-secondary);font-size:16px;line-height:1.7;max-width:66ch}.step-controls{display:flex;align-items:center;gap:12px}.step-controls button{min-height:44px;padding:0 13px;border:1px solid var(--border-solid);border-radius:10px;background:transparent;color:var(--text-secondary);font-family:var(--font-mono);font-size:12px;letter-spacing:.1em;text-transform:uppercase;cursor:pointer}.step-controls span{font-family:var(--font-mono);font-size:12px;color:var(--accent)}.role-boundary{margin-top:16px;padding:22px 26px;border-left:2px solid var(--accent);background:rgba(var(--accent-rgb),.045)}.role-boundary p{color:var(--text-secondary);font-size:15px;line-height:1.7;margin:10px 0 0;max-width:78ch}.about-role-actions{display:flex;flex-wrap:wrap;gap:12px}.identity-card{display:grid;grid-template-columns:260px 1fr;gap:clamp(32px,8vw,100px);align-items:center;padding:clamp(30px,6vw,70px);border:1px solid var(--border-solid);border-radius:22px;background:rgba(var(--surface-rgb),.74);backdrop-filter:blur(20px)}.identity-orbit{width:220px;height:220px;border:1px solid var(--border-solid);border-radius:50%;display:grid;place-items:center;position:relative}.identity-orbit:before,.identity-orbit:after{content:"";position:absolute;border:1px solid rgba(var(--accent-rgb),.2);border-radius:50%;inset:18%}.identity-orbit:after{inset:35%}.identity-orbit i{width:14px;height:14px;border-radius:50%;background:var(--text-muted)}.identity-orbit.signed-in i{background:var(--accent-bright);box-shadow:0 0 26px rgba(var(--accent-bright-rgb),.8)}.identity-copy h3{font-family:var(--font-display);font-size:clamp(2rem,4vw,3.7rem);line-height:1.05;margin:16px 0}.identity-copy p{color:var(--text-secondary);font-size:16px;line-height:1.72;max-width:64ch}.about-core-close{padding:clamp(110px,17vw,220px) 0 100px}.about-core-close h2{font-size:clamp(3rem,7vw,6.8rem)}.return-core{display:inline-block;margin-top:64px;color:var(--text-muted);font-family:var(--font-mono);font-size:12px;letter-spacing:.13em;text-transform:uppercase}
        ...
        .about-role-tabs strong{font-family:var(--font-display)}
        .step-controls button{min-height:44px}
        .return-core{display:inline-flex;align-items:center;min-height:44px}
        .about-core-primary,.about-core-secondary,.about-role-tabs button,.schematic-node,.step-controls button,.return-core{transition:color var(--transition-slow),border-color var(--transition-slow),background var(--transition-slow),transform var(--transition-slow)}
        .about-core-primary:hover,.about-core-secondary:hover,.schematic-node:hover,.step-controls button:hover,.return-core:hover{transform:translateY(-2px);color:var(--text-primary);border-color:var(--accent)}
        .about-core-primary:focus-visible,.about-core-secondary:focus-visible,.about-role-tabs button:focus-visible,.schematic-node:focus-visible,.step-controls button:focus-visible,.return-core:focus-visible{outline:2px solid var(--accent-bright);outline-offset:3px;position:relative;z-index:4}
        @media(prefers-reduced-motion:reduce){.about-core-primary,.about-core-secondary,.about-role-tabs button,.schematic-node,.step-controls button,.return-core{transition:none}.about-core-primary:hover,.about-core-secondary:hover,.schematic-node:hover,.step-controls button:hover,.return-core:hover{transform:none}}
        @media(prefers-reduced-transparency:reduce){.about-core-scrim{background:var(--bg)}.about-core-secondary,.about-role-tabs button{background:var(--surface)}.about-role-tabs button.is-active{background:var(--surface2)}}
      `}</style>
    </main>
  );
}
