...
export default function MantleArchive() {
  ...
  return (
    <main className="mantle-page">
      ...
      <style jsx global>{`
        .mantle-page{min-height:100vh;padding-top:52px;background:radial-gradient(circle at 50% 10%,rgba(var(--accent-rgb),.07),transparent 36%),linear-gradient(180deg,var(--bg),var(--surface));color:var(--text-primary);overflow-x:hidden;position:relative}.mantle-atmosphere{position:fixed;inset:0;z-index:0;pointer-events:none;opacity:.38}.mantle-pane{position:relative;z-index:1}.mantle-archive{max-width:1220px;margin:0 auto;padding:clamp(80px,10vw,140px) clamp(20px,5vw,72px)}.archive-intro{display:grid;grid-template-columns:1.2fr .8fr;gap:clamp(38px,8vw,110px);align-items:end;margin-bottom:64px}.archive-kicker{font-family:var(--font-mono);font-size:9px;letter-spacing:.18em;text-transform:uppercase;color:var(--accent)}.archive-intro h2{font-family:var(--font-display);font-size:clamp(2.8rem,6vw,5.7rem);line-height:.98;letter-spacing:-.045em;margin:20px 0 0}.archive-intro-copy p{color:var(--text-secondary);font-size:15px;line-height:1.7;max-width:50ch}.atmosphere-toggle{margin-top:18px;min-height:40px;padding:0 14px;border:1px solid var(--border-solid);border-radius:12px;background:rgba(var(--surface-rgb),.65);color:var(--text-secondary);font-family:var(--font-mono);font-size:9px;letter-spacing:.12em;text-transform:uppercase;cursor:pointer}.atmosphere-toggle:disabled{cursor:wait;opacity:.62}.atmosphere-toggle span{color:var(--accent);margin-right:9px}.archive-shell{display:grid;grid-template-columns:minmax(250px,.42fr) minmax(0,1.58fr);border:1px solid var(--border-solid);border-radius:22px;overflow:hidden;background:rgba(var(--bg-rgb),.82);backdrop-filter:blur(22px);box-shadow:var(--shadow-lg)}.archive-index{background:rgba(var(--surface-rgb),.76);border-right:1px solid var(--border-solid)}.archive-index button{width:100%;min-height:98px;padding:18px 20px;border:0;border-bottom:1px solid var(--border-solid);background:transparent;color:var(--text-primary);display:grid;grid-template-columns:34px 1fr;gap:5px 12px;text-align:left;cursor:pointer}.archive-index button:last-child{border-bottom:0}.archive-index button>span{grid-row:1/3;font-family:var(--font-mono);font-size:9px;color:var(--text-muted);letter-spacing:.14em;padding-top:3px}.archive-index strong{font-family:var(--font-display);font-size:1.12rem;font-weight:500}.archive-index small{font-family:var(--font-mono);font-size:8px;letter-spacing:.11em;text-transform:uppercase;color:var(--text-muted)}.archive-index button:disabled{cursor:wait}.archive-index button.is-active{background:rgba(var(--accent-rgb),.09);box-shadow:inset 2px 0 0 var(--accent)}.archive-index button.is-active>span,.archive-index button.is-active small{color:var(--accent)}.archive-disclosure{padding:clamp(34px,6vw,76px);animation:mantleReveal 220ms var(--ease-out-custom)}@keyframes mantleReveal{from{opacity:0;transform:translateY(8px)}to{opacity:1;transform:none}}.disclosure-copy{max-width:780px}.disclosure-copy h2{font-family:var(--font-display);font-size:clamp(2.5rem,5vw,5rem);line-height:1;letter-spacing:-.045em;margin:18px 0 24px;outline:none}.disclosure-copy p{color:var(--text-secondary);font-size:14px;line-height:1.78;max-width:72ch;margin:15px 0}.disclosure-copy .disclosure-intro{font-size:clamp(1rem,1.5vw,1.18rem);color:var(--text-primary);line-height:1.65;margin-bottom:28px}.mantle-diagram{margin:50px 0 30px;padding:24px;border:1px solid var(--border-solid);border-radius:16px;background:var(--surface)}.mantle-diagram figcaption{font-family:var(--font-mono);font-size:8px;letter-spacing:.14em;text-transform:uppercase;color:var(--text-muted);margin-bottom:20px}.diagram-flow{display:grid;grid-template-columns:repeat(3,1fr);gap:20px}.diagram-stage{min-height:100px;border:1px solid rgba(var(--accent-rgb),.2);border-radius:12px;padding:16px;background:rgba(var(--accent-rgb),.035);display:flex;flex-direction:column;justify-content:space-between;position:relative}.diagram-stage>span{font-family:var(--font-mono);font-size:8px;color:var(--accent)}.diagram-stage strong{font-family:var(--font-mono);font-size:9px;letter-spacing:.09em;text-transform:uppercase;line-height:1.5}.diagram-stage i{position:absolute;right:-16px;top:50%;transform:translateY(-50%);z-index:2;color:var(--accent);font-style:normal}.proof-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:1px;background:var(--border-solid);border:1px solid var(--border-solid);border-radius:16px;overflow:hidden}.proof-grid>div{min-height:92px;padding:18px;background:var(--surface)}.proof-grid span{display:block;font-family:var(--font-mono);font-size:8px;letter-spacing:.13em;text-transform:uppercase;color:var(--text-muted);margin-bottom:10px}.proof-grid strong{font-family:var(--font-mono);font-size: var(--type-micro);letter-spacing:.06em;line-height:1.5;color:var(--text-primary)}.archive-links{display:flex;flex-wrap:wrap;gap:12px;margin-top:34px}.archive-links a,.archive-links button{min-height:42px;padding:0 16px;border:1px solid var(--border-solid);border-radius:12px;background:transparent;color:var(--text-secondary);display:inline-flex;align-items:center;font-family:var(--font-mono);font-size:8px;letter-spacing:.12em;text-transform:uppercase;cursor:pointer}.archive-links a:hover,.archive-links button:hover{border-color:var(--accent);color:var(--text-primary)}.archive-links span{color:var(--accent);margin-left:8px}.archive-continuity{display:flex;justify-content:center;gap:8px;margin-top:34px}.archive-continuity a{width:38px;height:38px;border:1px solid var(--border-solid);border-radius:50%;display:grid;place-items:center;font-family:var(--font-mono);font-size:8px;color:var(--text-muted)}.archive-continuity a[aria-current=step]{border-color:var(--accent);color:var(--accent);background:rgba(var(--accent-rgb),.08)}
