...
const MANTLE_FLOW_SOURCE = getPublicLayerFlowSource("mantle");
  ...
  return (
    <main className="mantle-page">
      ...
      <div className="layer-pane mantle-pane">
        ...
        <section className="mantle-archive" aria-labelledby="mantle-index-title" data-flow-source={MANTLE_FLOW_SOURCE.chunkId}>
      ...
      <style jsx global>{`
        ...
        .atmosphere-toggle,.archive-links a,.archive-links button{min-height:44px;transition:color var(--transition-slow),border-color var(--transition-slow),background var(--transition-slow)}
        .archive-index button{transition:color var(--transition-slow),background var(--transition-slow)}
        .archive-continuity a{width:44px;height:44px;transition:color var(--transition-slow),border-color var(--transition-slow),background var(--transition-slow)}
        .atmosphere-toggle:not(:disabled):hover,.archive-index button:not(:disabled):hover,.archive-links a:hover,.archive-links button:hover,.archive-continuity a:hover{color:var(--text-primary);background:rgba(var(--accent-rgb),.055)}
        .atmosphere-toggle:focus-visible,.archive-links a:focus-visible,.archive-links button:focus-visible,.archive-continuity a:focus-visible{outline:2px solid var(--accent-bright);outline-offset:3px}
        .archive-index button:focus-visible{outline:2px solid var(--accent-bright);outline-offset:-3px;position:relative;z-index:2}
        @media(prefers-reduced-motion:reduce){.atmosphere-toggle,.archive-index button,.archive-links a,.archive-links button,.archive-continuity a{transition:none}}
        @media(prefers-reduced-transparency:reduce){.archive-index{background:var(--surface)}}
      `}</style>
    </main>
  );
}
