...
export default function AffordabilityCalculator({ listedPrice, priceStatus, tenure }) {
  ...
  return (
    <div style={{ marginTop: "24px", padding: "22px 24px", background: "#161616", border: "0.5px solid #262626", borderRadius: "4px" }}>
      <div style={{ fontFamily: "var(--font-mono)", fontSize: "var(--type-micro)", color: "#E8AE3C", letterSpacing: "0.18em", textTransform: "uppercase", marginBottom: "16px" }}>
      ...
      <p style={{ fontFamily: "system-ui,-apple-system,sans-serif", fontSize: "var(--type-micro)", color: "#5a5a5a", lineHeight: 1.6, marginTop: "18px" }}>
