...
const SpatialCommandMap = dynamic(() => import("@/components/property/SpatialCommandMap"), {
  ...
  loading: () => (
    <div style={{ height: "300px", background: "var(--surface)", border: "0.5px solid var(--border)", borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <span style={{ fontFamily: "var(--font-mono)", fontSize: "var(--type-micro)", letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--text-muted)" }}>Loading spatial command map…</span>
    </div>
  ),
});
const SpatialCanvas = dynamic(() => import("@/components/maps/SpatialCanvas"), {
  ...
  loading: () => (
    <div style={{ height: "300px", background: "var(--surface)", border: "0.5px solid var(--border)", borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <span style={{ fontFamily: "var(--font-mono)", fontSize: "var(--type-micro)", letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--text-muted)" }}>Loading spatial canvas…</span>
    </div>
  ),
});
    ...
    <>
      ...
      <div className="page" style={{ position: "relative" }}>
        ...
        <Link
          ...
          style={{ position: "absolute", top: "24px", left: "24px", zIndex: 100, color: "var(--text-muted)", fontFamily: "var(--font-mono)", fontSize: "var(--type-micro)", letterSpacing: "0.12em", textTransform: "uppercase", background: "var(--surface-var)", padding: "8px 12px", borderRadius: "4px", backdropFilter: "blur(4px)", textDecoration: "none", border: "0.5px solid var(--border)" }}
        >
          ← Back to {property.title}
        </Link>
          ...
          {displayPhotos.map((url, i) => (
            ...
            >
              {url ? (
                ...
                <span style={{ fontFamily: "var(--font-mono)", fontSize: "var(--type-micro)", color: "var(--text-muted)", letterSpacing: "0.15em", textTransform: "uppercase" }}>
        ...
        <div className="zone-story">
          ...
          <div className={`chapter-panel ${activeTab === "space" ? "active" : ""}`} id="panel-space">
            <div className="panel-content">
              <div style={{marginBottom:"32px"}}>
                <div style={{fontFamily:"var(--font-mono)", fontSize:"var(--type-micro)", color:"var(--text-secondary)", letterSpacing:"0.25em", textTransform:"uppercase", marginBottom:"10px"}}>01 — The Space</div>
              ...
              {scenarios.length > 0 && activeScenario && (
                <div style={{ background: "var(--surface2)", border: "0.5px solid var(--border)", borderRadius: "8px", padding: "22px" }}>
                  <div style={{ fontFamily: "var(--font-mono)", fontSize: "var(--type-micro)", color: ACCENT, letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: "14px" }}>
                    This space flexes ✦
                  </div>
                    ...
                    {scenarios.map((s) => {
                      ...
                      return (
                        <button
                          ...
                          style={{
                            fontFamily: "var(--font-mono)", fontSize: "var(--type-micro)", letterSpacing: "0.06em", textTransform: "uppercase",
          ...
          {d.differentiator && (
            <div className={`chapter-panel ${activeTab === "diff" ? "active" : ""}`} id="panel-diff">
              <div className="panel-content">
                <div style={{marginBottom:"32px"}}>
                  <div style={{fontFamily:"var(--font-mono)", fontSize:"var(--type-micro)", color:"var(--text-muted)", letterSpacing:"0.25em", textTransform:"uppercase", marginBottom:"10px"}}>02 — The Differentiator</div>
          ...
          <div className={`chapter-panel ${activeTab === "vault" ? "active" : ""}`} id="panel-vault">
            <div className="panel-content" style={{ maxWidth: "100%" }} tabIndex={0} aria-label="Scrollable Spatial Vault content">
              <div style={{marginBottom:"32px"}}>
                <div style={{fontFamily:"var(--font-mono)", fontSize:"var(--type-micro)", color:ACCENT, letterSpacing:"0.25em", textTransform:"uppercase", marginBottom:"10px"}}>PREMIUM — THE SPATIAL VAULT</div>
              ...
              {unlockedVault ? (
                ...
                <div style={{ position: "relative", width: "100%", padding: "24px", borderRadius: "8px", background: "linear-gradient(160deg, #111, #0a0a0a)", border: "0.5px solid var(--border)", overflow: "hidden", minHeight: "220px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
                  ...
                  <div style={{ position: "relative", zIndex: 2, display: "flex", flexDirection: "column", alignItems: "center", gap: "16px", textAlign: "center", padding: "20px" }}>
                    ...
                    <a href="/pricing/seeker" className="hover-glow" style={{ textDecoration: "none", fontFamily: "var(--font-mono)", fontSize: "var(--type-micro)", letterSpacing: "0.1em", textTransform: "uppercase", background: "transparent", border: "1px solid #E8AE3C", color: "#E8AE3C", padding: "12px 20px", borderRadius: "4px", fontWeight: "bold", transition: "all 0.3s ease" }}>
          ...
          <div className={`chapter-panel ${activeTab === "terms" ? "active" : ""}`} id="panel-terms">
            <div className="panel-content">
              <div style={{marginBottom:"32px"}}>
                <div style={{fontFamily:"var(--font-mono)", fontSize:"var(--type-micro)", color:"var(--text-muted)", letterSpacing:"0.25em", textTransform:"uppercase", marginBottom:"10px"}}>04 — Terms & Fit-Out</div>
                <div style={{height:"1px", background:"var(--border)"}}/>
              </div>

              {inclusions.length > 0 && (
                <div style={{ marginBottom: "24px" }}>
                  <div style={{ fontFamily:"var(--font-mono)", fontSize:"var(--type-micro)", color:ACCENT, letterSpacing:"0.15em", textTransform:"uppercase", marginBottom:"10px" }}>What&apos;s Included</div>
              ...
              {d.house_rules && (
                <div>
                  <div style={{ fontFamily:"var(--font-mono)", fontSize:"var(--type-micro)", color:ACCENT, letterSpacing:"0.15em", textTransform:"uppercase", marginBottom:"10px" }}>House Rules</div>
          ...
          <div className={`chapter-panel ${activeTab === "building" ? "active" : ""}`} id="panel-building">
            <div className="panel-content">
              <div style={{marginBottom:"32px"}}>
                <div style={{fontFamily:"var(--font-mono)", fontSize:"var(--type-micro)", color:"var(--text-muted)", letterSpacing:"0.25em", textTransform:"uppercase", marginBottom:"10px"}}>05 — Spatial Intelligence & Building</div>
                <div style={{height:"1px", background:"var(--border)"}}/>
              </div>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "10px", marginBottom: "16px" }}>
                ...
                {property.details?.spatial_intel?.peza?.is_accredited && (
                  <span style={{ fontFamily: "var(--font-mono)", fontSize: "var(--type-micro)", color: "#10B981", background: "rgba(16, 185, 129, 0.12)", border: "1px solid rgba(16, 185, 129, 0.3)", borderRadius: "4px", padding: "6px 12px", textTransform: "uppercase", letterSpacing: "0.08em" }}>
                    🏢 PEZA Certified ({property.details.spatial_intel.peza.zone_name})
                  </span>
                )}
                {property.details?.spatial_intel?.transit && (
                  <span style={{ fontFamily: "var(--font-mono)", fontSize: "var(--type-micro)", color: "#F7C64E", background: "rgba(232, 174, 60, 0.12)", border: "1px solid rgba(232, 174, 60, 0.3)", borderRadius: "4px", padding: "6px 12px", textTransform: "uppercase", letterSpacing: "0.08em" }}>
                ...
                {property.details?.spatial_intel?.seismic && (
                  <span style={{ fontFamily: "var(--font-mono)", fontSize: "var(--type-micro)", color: "var(--text-secondary)", background: "var(--surface)", border: "0.5px solid var(--border)", borderRadius: "4px", padding: "6px 12px", textTransform: "uppercase", letterSpacing: "0.08em" }}>
              ...
              <InViewport
                ...
                fallback={
                  <div style={{ height: "420px", background: "var(--surface)", border: "0.5px solid var(--border)", borderRadius: "4px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <span style={{ fontFamily: "var(--font-mono)", fontSize: "var(--type-micro)", letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--text-muted)" }}>Spatial command HUD</span>
                  </div>
                }
              >
                {USE_SPATIAL_CANVAS ? (
              ...
              <div style={{ marginTop: "24px" }}>
                <Link href={`/property/${property.slug}`} style={{ color: ACCENT, fontFamily: "var(--font-mono)", fontSize: "var(--type-micro)", letterSpacing: "0.1em", textTransform: "uppercase" }}>
          ...
          <div className={`chapter-panel ${activeTab === "yourmove" ? "active" : ""}`} id="panel-yourmove">
            <div className="panel-content">
              <div style={{marginBottom:"32px"}}>
                <div style={{fontFamily:"var(--font-mono)", fontSize:"var(--type-micro)", color:"var(--text-muted)", letterSpacing:"0.25em", textTransform:"uppercase", marginBottom:"10px"}}>06 — Your Move</div>
                <div style={{height:"1px", background:"var(--border)"}}/>
              </div>
              ...
              {scenarios.length > 0 && (
                <button
                  ...
                  style={{ display: "block", marginTop: "12px", maxWidth: "400px", width: "100%", background: "transparent", border: "0.5px solid var(--border)", color: "var(--text-muted)", fontFamily: "var(--font-mono)", fontSize: "var(--type-micro)", letterSpacing: "0.08em", textTransform: "uppercase", padding: "12px", borderRadius: "4px", cursor: "pointer" }}
                >
