        ...
        >
          {[
            ...
            return (
              ...
              >
                <div>{tab.label}</div>
                <div style={{ fontSize: "12px", marginTop: "2px" }}>{tab.badge}</div>
              </button>
            );
          })}
        </div>
        ...
        >
          ...
          >
            ...
            <div style={{ textAlign: "right" }}>
              ...
              <div style={{ fontSize: "12px", color: "#8a8a8a", marginTop: "4px", fontFamily: "var(--font-mono, monospace)" }}>
                3 CONNECTS SPENT
              </div>
            </div>
          </div>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              ...
              <div>
                ...
                <div style={{ fontSize: "12px", color: "#E8AE3C", fontFamily: "var(--font-mono, monospace)" }}>
          ...
          <div style={{ padding: "20px", minHeight: "220px" }}>
            {activeTab === "waiting" && (
              <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                ...
                />
                <div style={{ fontSize: "12px", color: "#8a8a8a", textAlign: "right", fontFamily: "var(--font-mono, monospace)" }}>
